...
#sys.path.append('/home/rafaelfabrichimidt/Documentos/projetos/python/etl_pipeline_weather_data_docker/')

#os.path.dirname('rafaelfabrichimidt/Documentos/projetos/python/etl_pipeline_weather_data_docker/')
